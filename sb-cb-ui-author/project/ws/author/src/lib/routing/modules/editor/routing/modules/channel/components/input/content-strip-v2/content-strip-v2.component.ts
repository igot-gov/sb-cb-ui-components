...
import { IPickerContentData, IWidgetElementHtml, NsContent } from '@ws-widget/collection'
...
import { NsContentStripMultiple } from '@ws-widget/utils/lib/services/content-strip-multiple.model'
...
// from './../../../../../../../../../../../../app/src/lib/routes/profile/routes/interest/services/interest.service'
...
export class ContentStripV2Component implements OnInit {
  @Output() data = new EventEmitter<{
    content: any  // NsContentStripMultiple.IContentStripMultiple
    isValid: boolean
  }>()
  @Input() content!: any // NsContentStripMultiple.IContentStripMultiple
  @Input() identifier = ''
